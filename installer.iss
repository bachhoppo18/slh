...
; thư mục dist\van_ban_tool\ (từ bước `pyinstaller van_ban_tool.spec`).
; Kết quả: file  Output\VanBanTool_Setup.exe  — đưa file này cho người dùng tải về.
;
...
#define MyAppName "Van Ban Tool"
#define MyAppVersion "1.0.0"
; ^ PHẢI khớp APP_VERSION trong van_ban_tool.py — đổi 1 chỗ thì đổi luôn 2 chỗ kia
;   (chỗ kia là version_info.txt).
#define MyAppExeName "van_ban_tool.exe"
...
AppPublisher=Van Ban Tool
DefaultDirName={localappdata}\Programs\VanBanTool
DefaultGroupName={#MyAppName}
DisableProgramGroupPage=yes
PrivilegesRequired=lowest
PrivilegesRequiredOverridesAllowed=dialog
OutputDir=Output
OutputBaseFilename=VanBanTool_Setup
...
Source: "dist\van_ban_tool\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[UninstallDelete]
; KHÔNG xoá %APPDATA%\VanBanTool khi gỡ cài đặt — đó là nơi lưu cấu hình, danh
